...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1">Manage and organize all permissions in your system</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4 flex flex-col sm:flex-row gap-4">
        <div class="flex-1">
            <input id="searchBox" type="search" placeholder="Search users..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none">
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Updated At</th>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    async function fetchPermissions(name = '') {
                        try {
                            const url = name ? `${apiUrl}?name=${encodeURIComponent(name)}` : apiUrl;
