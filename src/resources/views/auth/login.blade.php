...
<div class="mb-8 text-center">
    <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 mb-4">
...
<form method="POST" action="/login" class="space-y-5">
    ...
    <button
        type="submit"
        class="w-full py-2.5 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-semibold rounded-lg transition duration-200 transform hover:scale-105 shadow-lg hover:shadow-blue-500/50">
        Sign in
    </button>
</form>
